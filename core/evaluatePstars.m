function [Ps,Ps_final] = evaluatePstars(ab)
% evaulates analytical Pstar terms with specific ALPHAC_BAR probability
% lookup table generated by (slow) computation of analytical coefficients
%   (using computePstars in analytical mode):
%   Pstar_coefficients = computePstars(n_stars,[],'ANALYTIC');
...
Ps_final(2) =  - ab^4 + 4*ab^3 - 5*ab^2 + 2*ab;

Ps(3) = - ab^8 + 6*ab^7 - 15*ab^6 + 20*ab^5 - 16*ab^4 + 9*ab^3 - 4*ab^2 + ab;
Ps_final(3) = - ab^6 + 6*ab^5 - 15*ab^4 + 19*ab^3 - 12*ab^2 + 3*ab;

Ps(4) = - ab^10 + 8*ab^9 - 28*ab^8 + 56*ab^7 - 70*ab^6 + 57*ab^5 - 32*ab^4 + 14*ab^3 - 5*ab^2 + ab;
Ps_final(4) = - ab^8 + 8*ab^7 - 28*ab^6 + 56*ab^5 - 69*ab^4 + 52*ab^3 - 22*ab^2 + 4*ab;

Ps(5) = - ab^12 + 10*ab^11 - 45*ab^10 + 120*ab^9 - 210*ab^8 + 252*ab^7 - 211*ab^6 + 125*ab^5 - 55*ab^4 + 20*ab^3 - 6*ab^2 + ab;
Ps_final(5) =  - ab^10 + 10*ab^9 - 45*ab^8 + 120*ab^7 - 210*ab^6 + 251*ab^5 - 205*ab^4 + 110*ab^3 - 35*ab^2 + 5*ab;

Ps(6) = - ab^14 + 12*ab^13 - 66*ab^12 + 220*ab^11 - 495*ab^10 + 792*ab^9 - 924*ab^8 + 793*ab^7 - 501*ab^6 + 235*ab^5 - 86*ab^4 + 27*ab^3 - 7*ab^2 + ab;
Ps_final(6) = - ab^12 + 12*ab^11 - 66*ab^10 + 220*ab^9 - 495*ab^8 + 792*ab^7 - 923*ab^6 + 786*ab^5 - 480*ab^4 + 200*ab^3 - 51*ab^2 + 6*ab;
...
Ps_final(7) = - ab^14 + 14*ab^13 - 91*ab^12 + 364*ab^11 - 1001*ab^10 + 2002*ab^9 - 3003*ab^8 + 3431*ab^7 - 2996*ab^6 + 1981*ab^5 - 966*ab^4 + 329*ab^3 - 70*ab^2 + 7*ab;
...
Ps_final(8) = - ab^16 + 16*ab^15 - 120*ab^14 + 560*ab^13 - 1820*ab^12 + 4368*ab^11 - 8008*ab^10 + 11440*ab^9 - 12869*ab^8 + 11432*ab^7 - 7980*ab^6 + 4312*ab^5 - 1750*ab^4 + 504*ab^3 - 92*ab^2 + 8*ab;
...
Ps_final(9) = - ab^18 + 18*ab^17 - 153*ab^16 + 816*ab^15 - 3060*ab^14 + 8568*ab^13 - 18564*ab^12 + 31824*ab^11 - 43758*ab^10 + 48619*ab^9 - 43749*ab^8 + 31788*ab^7 - 18480*ab^6 + 8442*ab^5 - 2934*ab^4 + 732*ab^3 - 117*ab^2 + 9*ab;
...
Ps_final(10) = - ab^20 + 20*ab^19 - 190*ab^18 + 1140*ab^17 - 4845*ab^16 + 15504*ab^15 - 38760*ab^14 + 77520*ab^13 - 125970*ab^12 + 167960*ab^11 - 184755*ab^10 + 167950*ab^9 - 125925*ab^8 + 77400*ab^7 - 38550*ab^6 + 15252*ab^5 - 4635*ab^4 + 1020*ab^3 - 145*ab^2 + 10*ab;

Ps_final(11) = - ab^22 + 22*ab^21 - 231*ab^20 + 1540*ab^19 - 7315*ab^18 + 26334*ab^17 - 74613*ab^16 + 170544*ab^15 - 319770*ab^14 + 497420*ab^13 - 646646*ab^12 + 705431*ab^11 - 646635*ab^10 + 497365*ab^9 - 319605*ab^8 + 170214*ab^7 - 74151*ab^6 + 25872*ab^5 - 6985*ab^4 + 1375*ab^3 - 176*ab^2 + 11*ab;
